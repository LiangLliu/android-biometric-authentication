...
class BiometricPromptManger(
    ...
    fun showBiometricPrompt(
        ...
        val manger = BiometricManager.from(activity)
        ...
        when (manger.canAuthenticate(authenticators)) {
            ...
            BiometricManager.BIOMETRIC_ERROR_NONE_ENROLLED -> {
                resultChannel.trySend(BiometricResult.AuthenticationNoSet)
                return
            }
